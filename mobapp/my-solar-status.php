...
<div class="row pt-3 pb-4">
        ...
        <div class="col">
          ...
          <div class="bs-vertical-wizard" style="padding-bottom: 10px;">
                            <ul>
<?php 
$sql = "SELECT * FROM tbl_steps WHERE CustId='$UserId'";
$row = getList($sql);
foreach($row as $result){?>
                                <li class="complete">
                                    <a href="<?php echo $result['url'];?>"><?php echo $result['Steps'];?> <i class="ico fa fa-check ico-green"></i>
                                         <span class="desc">Created at <?php echo date("d M Y", strtotime(str_replace('-', '/',$result['CreatedDate'])));?> <?php echo $result['CreatedTime'];?></span>
                                    </a>
                                </li>
                               <?php } ?>
