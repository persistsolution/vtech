...
echo "<script>alert('Record Created Successfully!');window.location.href='../view-executive.php';</script>";
}
else{
...
echo "<script>alert('Record Updated Successfully!');window.location.href='../view-executive.php';</script>";
}
