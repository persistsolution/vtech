...
padding-left: 1px;">
    ...
    <div class='alert alert-warning'>Total Commission Amount : &#8377;<?php echo number_format($Wallet,2);?></div></span>
                        <ul class="list-group list-group-flush" id="show_prod">
                             <?php 
                                $sql2 = "SELECT * FROM wallet WHERE UserId='$UserId' AND Commission=1 AND Status='Cr'  ORDER BY id DESC"; 
