...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_insurance_clain SET CustId='$CustId',CellNo='$CellNo',CustName = '$CustName',Status='$Status',Address='$Address',DocumentsStatus='$DocumentsStatus',ClainReason = '$ClainReason',ClainStatus='$ClainStatus',CreatedDate='$CreatedDate',CreatedBy='$user_id'";
  $conn->query($qx);
  $PostId = mysqli_insert_id($conn);
  $TicketNo= "#".rand(1000,9999);
  $sql = "UPDATE tbl_insurance_clain SET TicketNo='$TicketNo' WHERE id='$PostId'";
  $conn->query($sql);
  echo "<script>window.location.href='view-insurance-claim.php';</script>";
}
else{
 
    $query2 = "UPDATE tbl_insurance_clain SET CustId='$CustId',CellNo='$CellNo',CustName = '$CustName',Status='$Status',Address='$Address',DocumentsStatus='$DocumentsStatus',ClainReason = '$ClainReason',ClainStatus='$ClainStatus',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id' WHERE id = '$id'";
  $conn->query($query2);
  echo "<script>window.location.href='view-insurance-claim.php';</script>";
...
<option selected="" value="">Select Customer</option>
 <?php 
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll=5 AND CreatedBy='$user_id'";
  $row12 = getList($sql12);
