...
$sql88 = "SELECT SUM(Amount) AS TotAmt FROM tbl_show_dealer_comm_amt WHERE DealerId='$UserId'";
...
padding-left: 1px;">
    ...
    <div class='alert alert-warning'>Total Make Commission Amount : &#8377;<?php echo number_format($Wallet,2);?></div></span>
                        <ul class="list-group list-group-flush" id="show_prod">
                             <?php 
                                $sql2 = "SELECT * FROM tbl_show_dealer_comm_amt WHERE DealerId='$UserId'  ORDER BY id DESC"; 
                            ...
                            <li class="list-group-item">
                               <div class="row align-items-center">
                                    ...
                                    <div class="col align-self-center pr-0">
                                        ...
                                        <h7 class="font-weight-normal mb-1" style="color: #212529"><?php echo $row['CustName']; ?><br></h7>
