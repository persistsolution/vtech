...
padding-left: 1px;">
                ...
                <div class="card mb-3">
                     <div class="card-header border-bottom">
                        <h6 class="mb-0" style="text-align: center;">My Hall Bookings</h6>
                    </div>
                     <?php 
                                     ...
                                     $ToDate = date("Y-m-d", strtotime(str_replace('/', '-',$_POST['ToDate'])));
                                       ...
                                       $sql2 = "SELECT ord.*,os.Name As OrderStatus,pm.Name As Payment_Method FROM orders ord 
                                           ...
                                           WHERE ord.UserId='$user_id' AND ord.Status=1 AND ord.Type=2 ORDER BY ord.srno DESC"; 
                                    ...
                                    //echo $sql2;
                                        ...
                                        if($row['OrderProcess'] == 1){
                                            $OrderStatus = "<span style='color:green;'>Hall Booked</span>";
                                        }
                                        ...
                                        $Total_Order = $row["OrderTotal"]+$row["ShippingCharge"]-$row["Promoprice"]-$row["Discount"];
                                     ?>
                    <div class="card-body position-relative">
                        ...
                        <div class="media">                            
                            <div class="media-body">
                                <h6 class="mb-1 text-default"><a href="my-hall-details.php?oid=<?php echo $row['id'];?>"><?php echo $row['OrderNo'];?></a></h6>
                                <h6 class="mb-1">&#8377;<?php echo number_format($Total_Order,2); ?></h6>
                            </div>
                            <a href="my-hall-details.php?oid=<?php echo $row['id'];?>" style="padding-top: 10px;"><button class="btn btn-sm btn-default rounded">View Details</button></a>                          
                        </div>
                    </div>
                    <hr >
                <?php }} ?>
