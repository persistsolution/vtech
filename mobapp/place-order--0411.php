...
?>             
            ...
            <input type="hidden" name="ShippingCharge" id="ShippingCharge" value="<?php echo $ShippingPrice; ?>"> 
             <input type="hidden" name="ServiceFee" id="ServiceFee" value="<?php echo $TotServiceFee; ?>"> 
           ...
           <input type="hidden" name="GrandTotal" id="GrandTotal" value="<?php echo $netamt+$TotServiceFee; ?>">
            <div class="container">
