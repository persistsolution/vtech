...
<body class="body-scroll d-flex flex-column h-100 menu-overlay" data-page="products">
 ...
 <script>
        function getDistance(val){
            var catid = $('#catid').val();
            var subid = $('#subid').val();
            window.location.href="service-provider-lists.php?cat_id="+catid+"&subid="+subid+"&dist="+val;
        }
    </script>
    ...
    if ($unit == "K") {
      ...
      return $miles;
                            ...
                            foreach($row11 as $result){
                             $subarr = explode(',',$result['SubCatid']);
            ...
            $tot_dist = round(distance($lat, $lng, $vedlat, $vedlong, "K"),1); 
                ...
                <div class="card mb-3">
                        ...
                        <div class="media">
                            <a href=""><div class="icon icon-60 mr-3 rounded">
                                <figure class="background">
                                    <?php if($result['ServicePhoto'] == '') {?>
                                                    <img src="no_image.jpg" alt="" style="width: 60px;height: 60px;">
                                                  <?php } else{?>
                                                    <img src="../uploads/<?php echo $result['ServicePhoto']; ?>" alt="" style="width: 60px;height: 60px;">
                                                  <?php } ?>
                            ...
                            <div class="media-body">
                                ...
                                <a href="service-details.php?id=<?php echo $result['id'];?>&cat_id=<?php echo $CatId;?>&subid=<?php echo $SubCatId; ?>"><h6 class="mb-1 text-default"><?php echo $result['ShopName'];?></h6></a>
                                <p class="small mb-0">
                 ...
                 <?php }} }} else{?>
                     <div class="card mb-3">
                    <div class="card-body position-relative">
                        <h5 style="color: red;">Oops! Service Providers Not Found Near By You...</h5>
                    </div>
                </div>
            <?php } ?>
