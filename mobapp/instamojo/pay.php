...
try {
    $response = $api->paymentRequestCreate(array(
       ...
       "redirect_url" => "https://dailydoorservices.com/mobapp1/instamojo/thankyou.php?userid=$userid&addid=$addid&ship_charge=$ship_charge&oid=$oid&OrderNo=$OrderNo",
