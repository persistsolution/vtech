...
$cat_id = $row7['CatId'];
 ...
 ?>
 <input type="hidden" name="Prod_Id" id="Prod_Id" value="<?php echo $_GET['id'];?>">
        <div class="main-container">
            ...
            <div class="container">
                ...
                <div class="col-auto">
                    <strong>Quantity Per Day</strong>
                        <div class="input-group cart-count cart-count-lg rounded">
                            ...
                            <input type="text" class="form-control rounded" placeholder="1" readonly="" name="quantity" id="qntno" value="1" min="1">
                   ...
                   <strong>Repeat</strong>
                        <select class="form-control" onchange="getDays(this.value)" name="Repeat">
                            <option value="daily">Daily</option>
                            <option value="weekdays">Weekdays</option>
                            <option value="weekends">Weekends</option>
                        </select>
                    </div><br>
                     <div class="col-auto daily" style="font-size: 15px;">
                  <div class="row">
                      <div class="col-3 col-md-3 col-lg-3">
                          <input type="checkbox" name="Daily[]" value="Mon" style="zoom:1.7;" checked> <span style="font-size:30">M</span>
                      </div>
                     <div class="col-3 col-md-3 col-lg-3">
                         <input type="checkbox" name="Daily[]" value="Tue" style="zoom:1.7;" checked> <span style="font-size:30">T</span>
                      </div>   
                      <div class="col-3 col-md-3 col-lg-3">
                      <input type="checkbox" name="Daily[]" value="Wed" style="zoom:1.7;" checked> <span style="font-size:30">W</span>
                      </div> 
                      <div class="col-3 col-md-3 col-lg-3">
                        <input type="checkbox" name="Daily[]" value="Thu" style="zoom:1.7;" checked> <span style="font-size:30">T</span>
                     </div>
                     <div class="col-3 col-md-3 col-lg-3">
                     <input type="checkbox" name="Daily[]" value="Fri" style="zoom:1.7;" checked> <span style="font-size:30">F</span>
                     </div>     
                    <div class="col-3 col-md-3 col-lg-3">
                      <input type="checkbox" name="Daily[]" value="Sat" style="zoom:1.7;" checked> <span style="font-size:30">S</span> 
                     </div>    
                    <div class="col-3 col-md-3 col-lg-3">
                        <input type="checkbox" name="Daily[]" value="Sun" style="zoom:1.7;" checked> <span style="font-size:30">S</span> 
                      </div>        
                  </div>       
                
                    </div>
                    <div class="col-auto weekdays" style="font-size: 15px;display: none;">
                    <div class="row">
                      <div class="col-3 col-md-3 col-lg-3">    
                 <input type="checkbox" name="WeekDays[]" value="Mon" style="zoom:1.7;" checked> <span style="font-size:30">M</span> 
                 </div> 
                 <div class="col-3 col-md-3 col-lg-3">
                    <input type="checkbox" name="WeekDays[]" value="Tue" style="zoom:1.7;" checked> <span style="font-size:30">T</span>  
                  </div>
                  <div class="col-3 col-md-3 col-lg-3">
                    <input type="checkbox" name="WeekDays[]" value="Wed" style="zoom:1.7;" checked> <span style="font-size:30">W</span> 
                  </div>
                  <div class="col-3 col-md-3 col-lg-3">
                     <input type="checkbox" name="WeekDays[]" value="Thu" style="zoom:1.7;" checked> <span style="font-size:30">T</span> 
                  </div>
                  <div class="col-3 col-md-3 col-lg-3">
                    <input type="checkbox" name="WeekDays[]" value="Fri" style="zoom:1.7;" checked> <span style="font-size:30">F</span>  
                  </div>
                 </div> 
                </div>
                    <div class="col-auto weekends" style="font-size: 15px;display: none;">
                   <div class="row">
                      <div class="col-3 col-md-3 col-lg-3">      
                 <input type="checkbox" name="Weekends[]" value="Sat" style="zoom:1.7;" checked> <span style="font-size: 30px;">S</span> 
                 </div>
                  <div class="col-3 col-md-3 col-lg-3">    
                 <input type="checkbox" name="Weekends[]" value="Sun" style="zoom:1.7;" checked> <span style="font-size: 30px;">S </span>   
                 </div>
                 </div>
                    </div>
      ...
      <div class="col-auto" style="padding-top:10px;">
                   <strong>Recharge / Top Up</strong>
                        <select class="form-control" name="Recharge">
                            ...
                            <option value="60">60 Deliveries</option>
                        </select>
                    </div> 
                     
      <div class="col-auto" style="padding-top:10px;">
                   <strong>Start Date</strong>
                    <input type="date" id="StartDate" name="StartDate" class="form-control" onchange="checkDate(this.value)" value="<?php echo date("Y-m-d", strtotime("+ 2 day")); ?>">
                    <span id="error_msg" style="color:red;display:none;">Please Select Day After Date</span>
                    </div> 
                                             
<br><br><br>
<input type="hidden" name="CurrDate" id="CurrDate" value="<?php echo date("Y-m-d", strtotime("+ 1 day")); ?>">
 <input type="hidden" name="pid" id="pid" value="<?php echo $_GET['id']; ?>">
  <input type="hidden" name="sizeid" id="sizeid" value="<?php echo $row7['SizeId']; ?>">
  <input type="hidden" name="ramid" id="ramid" value="<?php echo $row7['RamId']; ?>">
   <input type="hidden" name="storageid" id="storageid" value="<?php echo $row7['StorageId']; ?>">
   <input type="hidden" name="code" id="code" value="<?php echo $row7['code']; ?>">
<input type="hidden" name="prd_price" id="prd_price" value="<?php echo $row7['MinPrice']; ?>">
<input type="hidden" name="action" id="action" value="sub_shop_cart">
    ...
    <div class="row no-gutters" style="padding-top: 10px;">
                &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="col-auto" id="cart_btn">
                        <button class="btn btn-default rounded" id="add-cart" type="submit"><i class="material-icons">local_mall</i> Subscribe</button>
                    </div>
                </div>
