                    ...
                    <div class="card-body">
                      <input type="hidden" name="CatId" id="CatId" value="<?php echo $_GET['id']; ?>">
                        <div class="form-group float-label active">
                            <input class="form-control" id="MobileNo" name="MobileNo" type="number" min="0" minlength="10" maxlength="10" placeholder="" value="<?php echo $_GET['MobileNo']; ?>" autofocus>
...
getWallet();
    ...
    //console.log(data);exit();
      ...
      var msg = res.msg;
      var rechid = res.rechid;
       if(status == 0){
        window.location.href="recharge-history.php?rechid="+rechid;
       /*setTimeout(function () { 
swal({
...
function(isConfirm){
  if (isConfirm) {
          window.location.href="pay-recharge.php?optid="+optid+"&catid="+catid+"&id="+id;
  }
}); });*/
       }
