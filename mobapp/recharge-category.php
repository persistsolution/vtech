            ...
            <div class="card">
                    <div class="card-body text-center ">
                        <div class="row justify-content-equal no-gutters">
                             <?php 
                          $sql2 = "SELECT * FROM tbl_rec_category WHERE Status='1'";
                          $res2 = $conn->query($sql2);
                          while($row2 = $res2->fetch_assoc()){
                            $CatId = $row2['id'];
                        ?>
                        <div class="col-4 col-md-2 mb-3">
                                <a href="recharge-operator.php?catid=<?php echo $row2['id'];?>" class="rounded-circle mb-1  text-default">
                                    <img src="../uploads/<?php echo $row2['Photo']; ?>" style="width: 50px;height: 50px;">
                                </a>
