                        ...
                        ?>
                            <div class="col-4 col-md-2 mb-3">
                               <div class="card-body p-2">
                                    <a href="service-sub-category.php?cat_id=<?php echo $row2['id']; ?>"><div class="avatar avatar-60 mb-1 rounded">
                                        <div class="background">
                                          <?php if($row2["Photo2"] == '') {?>
                  <img src="no_image.jpg" style="width: 60px;height: 60px;"> 
                 <?php } else if(file_exists('../uploads/'.$row2["Photo2"])){?>
                 <img src="../uploads/<?php echo $row2["Photo2"];?>" alt="" style="width: 60px;height: 60px;">
                  <?php }  else{?>
                 <img src="no_image.jpg" style="width: 60px;height: 60px;"> 
             <?php } ?>
                                        </div>
