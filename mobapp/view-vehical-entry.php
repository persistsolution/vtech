...
<div class="row text-center mt-3">
    ...
    <?php 
            ...
            foreach($row77 as $result){
                    ...
                    $sql33 = "SELECT * FROM tbl_vehicle_details WHERE CreatedDate='".$result['CreatedDate']."' AND Type=1";
                    $rncnt33 = getRow($sql33);
                    $row33 = getRecord($sql33);

                    $sql34 = "SELECT * FROM tbl_vehicle_details WHERE CreatedDate='".$result['CreatedDate']."' AND Type=2";
