<?php
$from = 'From: Near By Store';
$subject = 'Order Placed Successfully From Near By Store';
...
$body .= 'Net Payment:  &#8377;'.number_format($total_price3+$ShippingCharge-$Promoprice,2).'<br>';
...
$body .= '<h3>Order Details :</h3><br><table style="border: 1px solid #ddd;text-align: left;border-collapse: collapse;width: 100%;">
  ...
  if($row_cnt > 0){
    while($row = $res2->fetch_assoc()){
 	...
 	<img src="https://nearbystore.in/uploads/'.$row['Photo'].'" alt="" style="width: 50px;"></td>
       <td style="border: 1px solid #ddd;text-align: left;padding: 15px;">
...
if($Promoprice == '' || $Promoprice == 0){} else{
     $body .= '<tr>
    <td colspan="2" style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong>Promocode Discount</strong></td>
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"></td>
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong style="color:red;">- &#8377;'.number_format($Promoprice,2).'</strong></td>
    </tr>';
  }
    $body .= '
    <tr>
   <td colspan="2" style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong>Grand Total</strong></td>
    ...
    <td style="border: 1px solid #ddd;text-align: left;padding: 15px;"><strong>&#8377;'.number_format($GrandTotal+$ShippingCharge-$Promoprice,2).'</strong></td>
    </tr>';
$body .= '</table><br>';
...
Thank You.<br>
Regards,<br>
<strong>Near By Store</strong><br>';
?>