            ...
            <div class="card">
                    <div class="card-body text-center ">
                        <div class="row justify-content-equal no-gutters">
                            <?php 
           $CatId = $_GET['catid'];
            $sql11 = "SELECT * FROM tbl_rec_operator WHERE Status=1 AND CatId='$CatId'";
            $row11 = getList($sql11);
            foreach($row11 as $result){
           ?>   
                        <div class="col-4 col-md-2 mb-3">
                            <?php if($CatId == 3) {?>
                                <a href="pay-dth-recharge.php?optid=<?php echo $result['Code']; ?>&catid=<?php echo $_GET['catid']; ?>&id=<?php echo $result['id']; ?>" class="rounded-circle mb-1 text-default"> <img src="../uploads/<?php echo $result['Photo']; ?>" style="width: 50px;height: 50px;"></a>
                            <?php } else{?>
                                <a href="pay-recharge.php?optid=<?php echo $result['Code']; ?>&catid=<?php echo $_GET['catid']; ?>&id=<?php echo $result['id']; ?>" class="rounded-circle mb-1 text-default"> <img src="../uploads/<?php echo $result['Photo']; ?>" style="width: 50px;height: 50px;"></a>
                            <?php } ?>
                                <p class="text-secondary"><small><?php echo $result['Name'];?></small></p>
                            </div>
