...
$id = $_GET['id'];
$sql7 = "SELECT tq.*,tu.Fname,tu.Address,tu.GstNo,tu.EmailId,tu.BankName,tu.AccountNo,tu.Branch,tu.IfscCode FROM tbl_quotation tq LEFT JOIN tbl_users tu ON tq.CompId=tu.id WHERE tq.id='$id'";
$row7 = getRecord($sql7);
?>
<table width="100%">
<tbody>
...
<p><a href="mailto:enquiry.vtech@gmail.com">State Name :&nbsp; Maharashtra, Code : 27<br /> <strong>E-Mail : <?php echo $row7['EmailId'];?></strong></a></p>
</td>
...
<td style="height: 105px; width: 8%;" rowspan="3">
<p>Terms of Delivery</p>
</td>
<td style="height: 105px; width: 47.0536%;" colspan="6" rowspan="3">
