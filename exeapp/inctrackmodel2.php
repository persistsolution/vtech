...
<input type="date" name="DelieverDate" class="form-control" placeholder="First Name" value="<?php echo $result['DelieverDate']; ?>" autocomplete="off">
</div>
<div class="form-group col-md-6">
<label class="form-label">Delivery Time </label>
<input type="text" name="DelieverTime" class="form-control" placeholder="" value="<?php echo $DelieverTime; ?>" autocomplete="off">
</div>
<input type="hidden" name="DispatchDate" value="<?php echo $result['DispatchDate']; ?>" id="DispatchDate">
<input type="hidden" name="DispatchTime" value="<?php echo $result['DispatchTime']; ?>" id="DispatchTime">
</div>
<div class="form-row">
<div class="form-group col-md-12">
<label class="form-label">Status <span class="text-danger">*</span></label>
  <select class="form-control" id="OrderStatus" name="OrderStatus" required="">
<option value="2" <?php if($result['OrderProcess'] == 2) {?> selected <?php } ?>>In Progress</option>
<option value="5" <?php if($result['OrderProcess'] == 5) {?> selected <?php } ?>>Dispatch</option>
<option value="1" <?php if($result['OrderProcess'] == 1) {?> selected <?php } ?>>Delivered</option>
</select>
