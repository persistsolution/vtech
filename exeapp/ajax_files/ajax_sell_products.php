...
if($Qty == $rncnt22){  
 ...
 if($_POST['action'] == 'getSerialProdRow'){
$i = $_POST['id'];?>

 <div class="form-row" id="row2<?php echo $i;?>">  

<div class="form-group col-md-4">
<label class="form-label">Barcode No / Serial No </label>
<div class="input-group">
<input type="text" list="browsers" name="BarcodeNo[]" id="BarcodeNo<?php echo $i;?>" class="form-control" placeholder="" value="" autocomplete="off" oninput="getSerialProdDetails(document.getElementById('SrNo<?php echo $i;?>').value,document.getElementById('BarcodeNo<?php echo $i;?>').value)">

  <div class="input-group-append">
                                  <button class="btn btn-primary" type="button" onclick="scanQrCode(<?php echo $i;?>)"><i class="fas fa-barcode"></i></button>
                               
                                </div>
                            </div>
<div class="clearfix"></div>
</div>
<input type="hidden" name="SerialProd[]" id="SerialProd<?php echo $i;?>">
<input type="hidden" name="SrNo[]" id="SrNo<?php echo $i;?>" class="form-control" placeholder="" value="<?php echo $i;?>">
<div class="form-group col-md-6">
<label class="form-label">Product Name </label>
<div class="input-group">
<input type="text" name="SerialProductName[]" id="SerialProductName<?php echo $i;?>" class="form-control" placeholder="" value="" autocomplete="off">
<span class="input-group-append">
    <button class="btn btn-danger btn_remove2" type="button" id="<?php echo $i;?>"><i class="feather icon-x"></i></button>
