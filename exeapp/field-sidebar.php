...
<div class="page-loader">
 ...
 <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-white logo-dark">
    ...
    <ul class="sidenav-inner">
        ...
        <li class="sidenav-item">
            <a href="field-service-dashboard.php" class="sidenav-link">
                <i class="sidenav-icon feather icon-home"></i>
                <div>Field Service Dashboard</div>
        ...
        <li class="sidenav-item">
            <a href="#" class="sidenav-link">
                <i class="sidenav-icon feather icon-home"></i>
                <div>Ticket Allocation / Assignment</div>
        ...
        <li class="sidenav-item">
            <a href="#" class="sidenav-link">
                <i class="sidenav-icon feather icon-home"></i>
                <div>Pending / Cancel / Closure</div>
        ...
        <li class="sidenav-item">
            <a href="#" class="sidenav-link">
                <i class="sidenav-icon feather icon-home"></i>
                <div>Part /Product Replacement Approvals</div>
        ...
        <li class="sidenav-item">
            <a href="#" class="sidenav-link">
                <i class="sidenav-icon feather icon-home"></i>
                <div>Closure With Happy Code</div>
