...
$SurveyFile = $imagepath2 ;
  ...
  $SurveyFile = $_POST['OldPhoto2'];
    ...
    $query2 = "UPDATE tbl_users SET SurveyDetails='$SurveyDetails',SurveyFile='$SurveyFile',SurveyDescription='$Details' WHERE id = '$id'";
  $conn->query($query2);
  echo "<script>alert('Survey Status Updated Successfully!');window.location.href='view-customers.php';</script>";
...
<h4 class="font-weight-bold py-3 mb-0">Update Survey Status</h4>
