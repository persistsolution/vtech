...
<body>
   ...
   <body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main">
            ...
            <?php include_once 'amc-sidebar.php'; ?>
                        ...
                        <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">AMC Product Definition</h6>
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">AMC Registrationfor Customer</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">Preventive Call Generation</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
                             ...
                             <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">AMC Maturity Tracking</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
