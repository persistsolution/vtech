...
<body>
   ...
   <body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main">
            ...
            <?php include_once 'sales-sidebar.php'; ?>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">FDFM ( Fixed Day Fixed Marketing )</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">Sales Travel Plan</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">Sales Convert to Order</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
