...
<?php 
$id = $_GET['cid'];
$sql7 = "SELECT tu.*,tu2.CustomerId As Dealer_Code,tu2.Fname As DealerName,tu2.id As DealerId FROM tbl_users tu INNER JOIN tbl_users tu2 ON tu.DealerCode=tu2.CustomerId WHERE tu.id='$id'";
...
$qx = "INSERT INTO wallet SET CustId='$CustId',UserId='$UserId',CustName='$CustName',DealerName='$DealerName',Dealer_Code='$Dealer_Code',Amount='$Amount',CreatedDate = '$CreatedDate',Status='Cr',Narration='$Narration',Photo='$Photo',Commission=1";
$conn->query($qx);

  echo "<script>alert('Commission Added To Dealer Wallet!');window.location.href='dealer-commission.php';</script>";
...
<input type="hidden" name="CustId" class="form-control" id="CustId" placeholder="" value="<?php echo $row7["id"]; ?>" readonly>
<input type="hidden" name="UserId" class="form-control" id="UserId" placeholder="" value="<?php echo $row7["DealerId"]; ?>" readonly>
 
  <div class="form-group col-lg-4">
<label class="form-label">Customer Name <span class="text-danger">*</span></label>
<input type="text" name="CustName" class="form-control" id="CustName" placeholder="" value="<?php echo $row7["Fname"]; ?>" readonly>
