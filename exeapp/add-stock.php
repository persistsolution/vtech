            ...
            if(trim($_POST["Qty"][$i] != '' || $_POST["Qty"][$i] != 0))  
              {
                ...
                $sql22 = "INSERT INTO tbl_stocks SET BranchId='$BranchId',InvId='$InvId',ProductId='$ProdId',ProductName='$ProdName',Qty='$Qty',Status='1',CrDr='cr',CreatedBy='$user_id',CreatedDate='$CreatedDate',Narration='$Narration'";
                $conn->query($sql22);
              }  
