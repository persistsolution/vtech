...
<body>
   ...
   <body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main">
            ...
            <?php include_once 'campaign-sidebar.php'; ?>
                        ...
                        <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">Campaign Creation / Planning</h6>
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">Data Capture from Excel</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2>0</h2>
                                        <h6 class="mb-0">Bulk Email / SMS</h6>
                                        <i class="lnr lnr-users hov-icon"></i>
                                     </div>
                                </div></a>
                            </div>
