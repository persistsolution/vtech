...
$sql7 = "SELECT ta.*,tu.Fname FROM tbl_vehicle_details ta INNER JOIN tbl_users tu ON ta.UserId=tu.id WHERE ta.UserId='$UserId' GROUP BY ta.CreatedDate ORDER BY ta.CreatedDate DESC";
$rncnt7 = getRow($sql7);
$row7 = getRecord($sql7);
?>
...
<form id="validation-form" method="post" autocomplete="off">
               ...
               <div class="card mb-4">
                    <div class="card-header">
                        <h6 class="mb-0" style="color:#e74623;">Vehical Entry</h6>
                    </div>
...
<div class="row text-center mt-3">
    ...
    <?php 
            ...
            foreach($row77 as $result){
                    ...
                    $sql33 = "SELECT * FROM tbl_vehicle_details WHERE CreatedDate='".$result['CreatedDate']."' AND Type=1 AND UserId='$UserId'";
                    $rncnt33 = getRow($sql33);
                    $row33 = getRecord($sql33);

                    $sql34 = "SELECT * FROM tbl_vehicle_details WHERE CreatedDate='".$result['CreatedDate']."' AND Type=2 AND UserId='$UserId'";
                    ...
                    if($rncnt34 > 0){
                        ...
                        //$ed_time = date("h:i a", strtotime(str_replace('-', '/',$row33['CreatedTime'])));
                        $ed_time = $row34['EndKm']." Km";
                    }
                    else{
