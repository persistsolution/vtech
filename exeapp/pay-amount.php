...
$Photo = $imagepath ;
  ...
  $Photo = $_POST['OldPhoto'];
    ...
    $query2 = "UPDATE tbl_quotation SET PaidAmt = '$PaidAmt',PayMode='$PayMode',Photo='$Photo',Narration = '$Narration',PaidStatus='1',PaidDate='$PaidDate' WHERE id = '$id'";
  $conn->query($query2);
  
  $sql = "DELETE FROM tbl_cust_payment WHERE QtId='$id' AND Type=0";
  $conn->query($sql);
  $sql = "INSERT INTO tbl_cust_payment SET QtId='$id',Amount='$PaidAmt',PayDate='$PaidDate',PayMode='$PayMode',Narration = '$Narration',Status=1,CreatedBy='$user_id',CreatedDate='$CreatedDate',Photo='$Photo',Type=0";
  $conn->query($sql);
...
<input type="text" name="PaidAmt" id="PaidAmt" class="form-control" value="<?php echo $row7["PaidAmt"]; ?>" required oninput="calBalAmt()">
<div class="clearfix"></div>
</div>
