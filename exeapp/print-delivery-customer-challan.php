...
<?php  
$id = $_GET['id'];
$sql7 = "SELECT tp.*,tu.GstNo,tu.EmailId,tu.Fname,tu.Phone FROM tbl_delivered_invoice tp 
...
<p>&nbsp;</p>
<p><strong>PHONE NO. : <?php echo $row['Phone'];?> <br>EMAIL ID. : <?php echo $row['EmailId'];?></strong></p>
