...
<li class="sidenav-item <?php if($MainPage=='Lead') {?> open active <?php } ?>">
<a href="javascript:" class="sidenav-link sidenav-toggle">
<i class="sidenav-icon feather icon-headphones"></i>
<div>Leads</div>
</a>
...
<li class="sidenav-item <?php if($MainPage=='Accessories') {?> open active <?php } ?>">
<a href="javascript:" class="sidenav-link sidenav-toggle">
<i class="sidenav-icon feather icon-headphones"></i>
<div>Accessories</div>
</a>
...
<li class="sidenav-item">
<a href="add-accessories.php" class="sidenav-link">
<div> Add Accessories</div>
<?php if($Page=='Add-Accessories') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
...
<li class="sidenav-item">
<a href="view-accessories.php" class="sidenav-link">
<div> View Accessories</div>
<?php if($Page=='View-Accessories') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
...
<li class="sidenav-item">
<a href="add-accessories-stock.php" class="sidenav-link">
<div> Add Stock</div>
<?php if($Page=='Add-Accessories-Stock') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
...
<li class="sidenav-item">
<a href="view-accessories-stocks.php" class="sidenav-link">
<div> View Stocks</div>
<?php if($Page=='View-Accessories-Stock') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
...
<li class="sidenav-item">
<a href="add-accessories-sell.php" class="sidenav-link">
<div> Add Sell</div>
<?php if($Page=='Add-Accessories-Sell') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
...
<li class="sidenav-item">
<a href="view-accessories-sells.php" class="sidenav-link">
<div> View Sell</div>
<?php if($Page=='View-Accessories-Sell') {?>
<div class="pl-1 ml-auto">
<span class="badge badge-dot badge-primary"></span>
</div>
<?php } ?>
