    ...
    <div class="main-menu">
        ...
        <?php } } ?>
            <ul class="nav nav-pills flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0)" onclick="checkRunningTrip(<?php echo $user_id;?>)">
                        <div>
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="running-trips.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Running Trips
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="view-trips.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Completed Trips
                        </div>
