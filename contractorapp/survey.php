...
<div class="card mb-4">
                    ...
                    <div class="card-body">
                        <h6 style="margin-bottom: 1px;"><?php echo $row['Fname']." ".$row['Lname']; ?></h6>
                        <address style="margin-bottom: 1px;">
                            <?php echo $row['Address']; ?>
                        </address>
                        <p style="margin-bottom: 1px;">Ph.: <?php echo $row['Phone']."<br>".$row['Phone2']; ?></p>
                        <p style="margin-bottom: 1px;">Reg Date : <?php echo date("d/m/Y", strtotime(str_replace('-', '/',$row['CreatedDate']))); ?></p>
                        <p style="margin-bottom: 1px;">Survey Date : <?php if($row['FieldSurveyDate']!='') { echo date("d/m/Y", strtotime(str_replace('-', '/',$row['FieldSurveyDate']))); } ?></p>
                        <p style="margin-bottom: 1px;">Project Type :  <?php if($row["ProjectType"]=='1') {?> <span style="color:red;font-weight:bold;font-size: 17px;">Pump Projects</span> 
