...
?>
            ...
            $sql = "SELECT tp.*,tc.Name As IssueName,tu.BeneficiaryId,tu.EmailId,tu.ProjectType FROM tbl_service_complaint tp
                    ...
                    LEFT JOIN tbl_users tu ON tu.id=tp.CustId WHERE tp.EnggAssignId='$user_id' AND tp.ClainStatus='Pending'";
            if($_REQUEST['Village']!=''){
...
<div class="card mb-4" id="bgcolor<?php echo $row['id'];?>">
                  ...
                  <?php } ?>
                   ...
                   <p style="margin-bottom: 1px;">
                     <a href="take-complaint-action.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-finish">Take Action</a>
                   </p>
