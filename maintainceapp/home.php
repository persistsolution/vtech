        ...
        <div class="main-container  text-center" style="background-color:#fff;">
           ...
           <div class="row justify-content-equal no-gutters mt-4">
                            ...
                            <div class="col-4 col-md-2 mb-3">
                                ...
                                <p class="text-secondary"><small style="font-size: 12px;font-weight: 700;font-family: Sans-serif;text-transform: uppercase;color:#000;">Pending Complaints</small></p>
                            </div>
                            ...
                            <div class="col-4 col-md-2 mb-3">
                                ...
                                <p class="text-secondary"><small style="font-size: 12px;font-weight: 700;font-family: Sans-serif;text-transform: uppercase;color:#000;">Completed Complaints</small></p>
                            </div>
