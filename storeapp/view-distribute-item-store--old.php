...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
 ...
 <div class="container">
                    ...
                    LEFT JOIN tbl_users tu ON ts.StoreInchId=tu.id WHERE ts.Status=1 AND ts.BranchId='$BranchId'";
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-auto pl-0">
                                                        <a href="view-assigning-items.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-finish">View</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    LEFT JOIN tbl_users tu ON ts.StoreInchId=tu.id WHERE ts.Status=1 AND ts.BranchId='$RoofBranchId'";
                                $sql .= " ORDER BY ts.id DESC";
                                //echo $sql;
                                $res = $conn->query($sql);
                                while ($row = $res->fetch_assoc()) {
                                        ...
                                        <div class="card mb-4" id="bgcolor<?php echo $row['id']; ?>">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-auto pl-0">
                                                        <a href="view-rooftop-assigning-items.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-finish">View</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
