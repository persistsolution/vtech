...
$sql = "UPDATE tbl_service_complaint SET ClainStatus='$ClainStatus',EnggSolveStatus='$ClainStatus',EnggAssignStatus='0',EnggAssignId=0,EnggAssignDate='' WHERE id='$id'";
$conn->query($sql);
}
else{
...
// $otp = rand(1000,9999);
// $_SESSION['otp'] = $otp;
echo "<script>window.location.href='pending-insurance-complaints.php';</script>";
}
?>
