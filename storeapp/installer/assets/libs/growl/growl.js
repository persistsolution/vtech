! function(t, i) {
    var e = function(t) {
        ...
        266: function(t, i) {
            ...
            function n(t, i) {
                ...
                t = jQuery, i = function() {
                    var t = function() {
                        ...
                        return e(t, null, [{
                            ...
                            value: function(t) {
                                var i, e, n, s;
                                for (s in i = t[0], e = this.transitions)
                                    if (n = e[s], null != i.style[s]) return n
                            }
                        }]), t
                    }();
                    ...
                    var s = function() {
                        function s() {
                            ...
                            n(this, s), this.render = this.render.bind(this), this.bind = this.bind.bind(this), this.unbind = this.unbind.bind(this), this.mouseEnter = this.mouseEnter.bind(this), this.mouseLeave = this.mouseLeave.bind(this), this.click = this.click.bind(this), this.close = this.close.bind(this), this.cycle = this.cycle.bind(this), this.waitAndDismiss = this.waitAndDismiss.bind(this), this.present = this.present.bind(this), this.dismiss = this.dismiss.bind(this), this.remove = this.remove.bind(this), this.animate = this.animate.bind(this), this.$growls = this.$growls.bind(this), this.$growl = this.$growl.bind(this), this.html = this.html.bind(this), this.content = this.content.bind(this), this.container = this.container.bind(this), this.settings = t.extend({}, s.settings, i), this.initialize(this.settings.location), this.render()
                        }
                        return e(s, null, [{
                            key: "growl",
                            value: function() {
                            ...
                            value: function(i) {
                                var e;
                                return t("body:not(:has(#" + (e = "growls-" + i) + "))").append('<div id="' + e + '" />')
                            }
                        }, {
                            key: "render",
                            value: function() {
                            ...
                            key: "animate",
                            value: function(t, e) {
                                var n, s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "in",
                                    o = arguments[3];
                                n = i.transition(t), t["in" === s ? "removeClass" : "addClass"](e), t.offset().position, t["in" === s ? "addClass" : "removeClass"](e), null != o && (null != n ? t.one(n, o) : o())
                            }
                        }, {
                            key: "$growls",
                            value: function(i) {
                                var e;
                                return null == this.$_growls && (this.$_growls = []), null != (e = this.$_growls)[i] ? e[i] : e[i] = t("#growls-" + i)
                            }
                        }, {
                            key: "$growl",
                            value: function() {
                ...
                }(), this.Growl = s, t.growl = function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return s.growl(t)
                }, t.growl.error = function() {
                    var i, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return i = {
                        title: "Error!",
                        style: "error"
                    }, t.growl(t.extend(i, e))
    ...
    if ("object" == typeof e) {
        ...
        for (var s in e) n[0] && (n[0][s] = e[s]), n[1] && "__esModule" !== s && (n[1][s] = e[s]), n[2] && (n[2][s] = e[s])
    }
}(this);