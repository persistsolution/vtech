        ...
        else
        {
            ...
            else
            {
                ...
                $name2 = $filename2;
                 ...
                 unlink($resizeimag);
                 unlink($filename2);
                 $sql = "DELETE FROM tbl_crop_image WHERE SessionId='$sessionid' AND UserId = '$UserId' AND SrNo = '2'";
                 $conn->query($sql);
                $q = "INSERT INTO tbl_crop_image SET Image = '$my_image_path',SessionId='$sessionid',UserId = '$UserId',SrNo = '2'";
                $conn->query($q);  
