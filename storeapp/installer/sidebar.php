...
$sql1101 = "SELECT tu.*,tut.Name As UserType FROM tbl_users tu LEFT JOIN tbl_user_type tut ON tu.Roll=tut.id WHERE tu.id='$user_id2'";
$row1101 = getRecord($sql1101);
$Name22 = $row1101['Fname']." ".$row1101['Lname'];
 ?>
    <!-- menu main -->
    <div class="main-menu">
        <div class="row mb-4 no-gutters">
            ...
            <div class="col-auto">
                ...
                <?php } else  {?>
                     <img src="<?php echo $Uploadurl;?>/uploads/<?php echo $row1101['Photo']; ?>" alt="" style="width: 140px;height: 140px;">
            ...
            <div class="col pl-3 text-left align-self-center">
                <h6 class="mb-1"><?php echo $Name22; ?></h6>
        ...
        <div class="menu-container">
            ...
            <ul class="nav nav-pills flex-column ">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="../installers.php">
                        <div>
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="../assign-survey-sites.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Assign Survey Sites
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../assign-dispatch-sites.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Assign Dispatch Sites
                        </div>
                        <!--<span class="arrow material-icons">chevron_right</span>-->
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../assign-installation-sites.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Assign Installation Sites
                        </div>
                        <!--<span class="arrow material-icons">chevron_right</span>-->
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../assign-inspection-sites.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Assign Inspection Sites
                        </div>
                        <!--<span class="arrow material-icons">chevron_right</span>-->
                    </a>
                </li>
