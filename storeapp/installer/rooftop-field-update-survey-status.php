...
if($row78["FieldLattitude"] == ''){
    $Fieldlat = $Latitude;
}
else{
    $Fieldlat = $row78["FieldLattitude"];
}

if($row78["FieldLongitude"] == ''){
    $FieldLong = $Longitude;
}
else{
    $FieldLong = $row78["FieldLongitude"];
}
?>
...
<input type="text" class="form-control" placeholder="" name="ConsumerNo" value="<?php echo $row7['ConsumerNo']; ?>">
 <div class="clearfix"></div>
</div>
...
<label class="form-label">Distance From LT Panel (Ongrid & Hybrid) in meters</label>
