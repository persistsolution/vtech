...
$sql2 = "SELECT te.*,tu.Fname FROM tbl_rooftop_sell te LEFT JOIN tbl_users tu ON te.CustId=tu.id WHERE te.id='$InvId'";
$row2 = getRecord($sql2);
$CustId = $row2['CustId'];
...
$sql33 = "DELETE FROM tbl_rooftop_general_ledger WHERE EmiId='$postid'";
$conn->query($sql33);
$sql2 = "SELECT MAX(SrNo) as maxid FROM tbl_rooftop_general_ledger WHERE Type='PR'";
    $row2 = getRecord($sql2);
    if($row2['maxid'] == ''){
        $SrNo = 1;
        $Code = "PR".$SrNo;
    ...
    $sql4 = "INSERT INTO tbl_rooftop_general_ledger SET SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$ReceiptNo',TotAmt='0',TotPaidAmt='0',TotBalAmt='0',PaidAmt='$ReceiptAmt',BalAmt='0',CrDr='cr',Roll=5,Type='PR',CreatedDate='$CreatedDate',SellId='$InvId',Narration='$Narration',EmiId='$postid',PayMode='$PayMode'";
    $conn->query($sql4);
