            ...
            {  
                ...
                {  
                     if($_POST["Capacity"][$i] != '')  
                     {
                       ...
                       $sql = "INSERT INTO tbl_contractor_commision SET UserId='$EmpId',Capacity='$Capacity',SelectionVal='$SelectionVal',FieldSurveyVal='$FieldSurveyVal',DispatchVal='$DispatchVal',FoundationVal='$FoundationVal',InstallationVal='$InstallationVal',InspectionVal='$InspectionVal',DocumentationVal='$DocumentationVal'";
                       $conn->query($sql);
                     }
                }
            }
...
echo "<script>alert('Record Created Successfully!');window.location.href='../user_management/view-installer.php';</script>";
}
else{
$sql = "UPDATE tbl_users SET UnderUser='$UnderUser',Fname='$Fname',Mname='$Mname',Lname='$Lname',Phone='$Phone',EmailId='$EmailId',Password='$Password',Phone2='$Phone2',CountryId='$CountryId',StateId='$StateId',CityId='$CityId',Address='$Address',Pincode='$Pincode',Status='$Status',Photo='$Photo',Roll='40',ModifiedDate='$CreatedDate',ModifiedBy='$user_id',GstNo='$GstNo',Photo2='$Photo2',Photo3='$Photo3',Details='$Details',CatId='$CatId',PanNo='$PanNo',Options='$Options',CompId='$CompId',BranchId='$BranchId',FatherPhone='$FatherPhone',Designation='$Designation',Dob='$Dob',AadharNo='$AadharNo',BloodGroup='$BloodGroup',JoinDate='$JoinDate',EmailId2='$EmailId2',InTime='$InTime',OutTime='$OutTime',CompName='$CompName',AgencyId='$AgencyId',AccountName='$AccountName',BankName='$BankName',AccountNo='$AccountNo',IfscCode='$IfscCode',Branch='$Branch',UpiNo='$UpiNo' WHERE id='$id'";
$conn->query($sql);

$sql = "UPDATE tbl_user2 SET LeadTeam='$LeadTeam',GstRegNo='$GstRegNo',GstRegPhoto='$GstRegPhoto',PanCardNo='$PanCardNo',PanCardPhoto='$PanCardPhoto',Gumastha='$Gumastha',GumasthaPhoto='$GumasthaPhoto',AreaOperation='$AreaOperation',StoreAvailability='$StoreAvailability',StoreAddress='$StoreAddress',AreaSqft='$AreaSqft',Covered='$Covered',Security='$Security',StoreManager='$StoreManager',CapacityPump='$CapacityPump',NoOperationalGate='$NoOperationalGate',NoOfTeams='$NoOfTeams',CountOfMembers='$CountOfMembers',MemberName='$MemberName',AreaQty='$AreaQty',AgencyName='$AgencyName',Year='$Year',Quantity='$Quantity',WorkDone='$WorkDone',OwnedVehicle='$OwnedVehicle',RentedVehicle='$RentedVehicle',NoOfVehicles='$NoOfVehicles',PerDaySurvey='$PerDaySurvey',PerDayDispatch='$PerDayDispatch',PerDayIC='$PerDayIC',PerDayInspection='$PerDayInspection',WeeklyBilling='$WeeklyBilling',15DayBilling='$F15DayBilling',MonthlyBilling='$MonthlyBilling',PumpBilling='$PumpBilling',AadharCardAllMember='$AadharCardAllMember',WorkmenCompensation='$WorkmenCompensation' WHERE id='$id'";
$conn->query($sql);

$sql = "DELETE FROM tbl_contractor_commision WHERE UserId='$id'";
$conn->query($sql);
if($_POST["Capacity"] != ''){
$number = count($_POST["Capacity"]);
 if($number > 0)  
            {  
                ...
                {  
                     if($_POST["Capacity"][$i] != '')  
                     {
                       ...
                       $sql = "INSERT INTO tbl_contractor_commision SET UserId='$id',Capacity='$Capacity',SelectionVal='$SelectionVal',FieldSurveyVal='$FieldSurveyVal',DispatchVal='$DispatchVal',FoundationVal='$FoundationVal',InstallationVal='$InstallationVal',InspectionVal='$InspectionVal',DocumentationVal='$DocumentationVal'";
                       $conn->query($sql);
                     }
                }
            }
...
echo "<script>alert('Record Updated Successfully!');window.location.href='../user_management/view-installer.php';</script>";
}
