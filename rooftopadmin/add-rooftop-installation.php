...
if(isset($_POST['submit'])){
    ...
    $BalanceAmount = addslashes(trim($_POST['BalanceAmount']));
    $randno = rand(1,100);
...
<option selected="" value="">Select Customer</option>
 <?php 
  ...
  $sql12 = "SELECT tu.*,td.InvNo,td.InvoiceDate FROM tbl_delivered_invoice td 
                    LEFT JOIN tbl_users tu ON td.CustId=tu.id WHERE tu.Roll=5 AND tu.ProjectType=2";
            }
        else{
$sql12 = "SELECT tu.*,td.InvNo,td.InvoiceDate FROM tbl_delivered_invoice td 
                    LEFT JOIN tbl_users tu ON td.CustId=tu.id WHERE tu.Roll=5 AND tu.ProjectType=2";
...
<div class="form-group col-md-12">
   <label class="form-label">Google Drive Link</label>
     <textarea name="DriveLink" id="DriveLink" class="form-control"  
                                                ><?php echo $row7['DriveLink']; ?></textarea>
    <div class="clearfix"></div>
 </div>
                                        <div class="form-group col-md-6">
                                     ...
                                     <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-3">
                                         ...
                                         <div class="form-group col-md-3">
                                            <label class="form-label">Install Done  <span class="text-danger">*</span></label>
...
<div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="PaidAmount" id="PaidAmount" class="form-control"
                                                placeholder="" value="<?php echo $row7["PaidAmount"]; ?>"
                                                autocomplete="off">
                                            <div class="clearfix"></div>
                                        </div> 
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" name="BalanceAmount" id="BalanceAmount" class="form-control"
                                                placeholder="" value="<?php echo $row7["BalanceAmount"]; ?>"
                                                autocomplete="off">
                                            <div class="clearfix"></div>
                                        </div>
