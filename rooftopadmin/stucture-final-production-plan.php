...
$MainPage="Final-Production-Plan";
$Page = "Stucture-Final-Production-Plan";
...
<h4 class="font-weight-bold py-3 mb-0">Final Stucture Production Plan</h4>
...
<button type="button" name="submit" class="btn btn-primary btn-finish"  onclick="search(document.getElementById('WaterSource').value,document.getElementById('BoreDia').value,document.getElementById('PumpHead').value,document.getElementById('StateId').value,document.getElementById('District').value,document.getElementById('Taluka').value,document.getElementById('MinLimit').value,document.getElementById('MaxLimit').value)">Search</button>
</div>
...
<script>
function search(WaterSource,BoreDia,PumpHead,StateId,District,Taluka,MinLimit,MaxLimit){
    if(MinLimit==''){
    ...
    $('#target-content').show();
var action = 'structure-final';
      $.ajax({
  type: "POST",
  url: "ajax_files/ajax_production_plan.php",
   data:{action:action,WaterSource:WaterSource,BoreDia:BoreDia,PumpHead:PumpHead,StateId:StateId,District:District,Taluka:Taluka,MinLimit:MinLimit,MaxLimit:MaxLimit},  
