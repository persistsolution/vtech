...
<input type="text" name="Name" class="form-control" id="Name" placeholder="Brand Name" required>
  ...
  $(document).ready(function() {
    ...
    $('#example').DataTable( {
      ...
      $('#add_button').click(function(){  
           $('.modal-title').html("Add <span class='font-weight-light'>Brand</span>");  
           $('#action').val("Add");  
           $('#id').val('');
                ...
                success:function(data){  
                    ...
                    $('#Status').val(data.Status).attr("selected",true);  
                     ...
                     $('#action').val('Edit'); 
                       ...
                       $('#submit').text("Update");   
                       $('.insert_frm').modal('show');
                         $('.modal-title').html("Update <span class='font-weight-light'>Brand</span>"); 
