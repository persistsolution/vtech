            ...
            <?php include_once 'product-sidebar.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        <h5 class="font-weight-bold py-3 mb-0">Add Product</h5>
                        
 <?php 
$id = $_GET['id'];
$sql7 = "SELECT * FROM tbl_rooftop_products WHERE id='$id'";
$row7 = getRecord($sql7);
...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_rooftop_products SET CGST='$CGST',SGST='$SGST',IGST='$IGST',Photo2='$Photo2',ProductCode='$ProductCode',BrandId='$BrandId',CatId='$CatId',ProductName = '$ProductName',Status='$Status',ModelNo='$ModelNo',Photo='$Photo',Price = '$Price',Details='$Details',CreatedDate='$CreatedDate',CreatedBy='$user_id',Code='$Code',Unit='$Unit',Roll='$Roll',BarcodeNo='$BarcodeNo',ProdSpec='$ProdSpec'";
  $conn->query($qx);
  $id = mysqli_insert_id($conn);
  $PrdNo = "1000".$id;
  $sql = "UPDATE tbl_rooftop_products SET PrdNo='$PrdNo' WHERE id='$id'";
  $conn->query($sql);
  echo "<script>alert('Product Added Successfully!');window.location.href='view-products.php';</script>";
}
else{
 
    $query2 = "UPDATE tbl_rooftop_products SET CGST='$CGST',SGST='$SGST',IGST='$IGST',Photo2='$Photo2',ProductCode='$ProductCode',BrandId='$BrandId',CatId='$CatId',ProductName = '$ProductName',Status='$Status',ModelNo='$ModelNo',Photo='$Photo',Price = '$Price',Details='$Details',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',Code='$Code',Unit='$Unit',Roll='$Roll',BarcodeNo='$BarcodeNo',ProdSpec='$ProdSpec' WHERE id = '$id'";
  $conn->query($query2);
...
<input type="text" name="BarcodeNo" class="form-control" id="BarcodeNo" placeholder="" value="<?php echo $BarcodeNo; ?>" required readonly>
<div class="clearfix"></div>
</div>-->

<div class="form-group col-lg-3">
<label class="form-label">HSN Code <span class="text-danger">*</span></label>
<input type="text" name="ModelNo" class="form-control" id="ModelNo" placeholder="" value="<?php echo $row7["ModelNo"]; ?>" required>
<div class="clearfix"></div>
</div>
...
<input type="number" name="CGST" class="form-control" id="CGST" placeholder="" value="<?php echo $row7["CGST"]; ?>" required>
<div class="clearfix"></div>
</div>
...
<label class="form-label">Product Specification </label>
  <select class="form-control" id="ProdSpec" name="ProdSpec" >
<option value="0" selected>...</option>
<option value="1" <?php if($row7["ProdSpec"]=='1') {?> selected <?php } ?>>BOS</option>
<option value="2" <?php if($row7["ProdSpec"]=='2') {?> selected <?php } ?>>Structure</option>
</select>
<div class="clearfix"></div>
</div>  -->
