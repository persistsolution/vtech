...
?>
                ...
                <tbody>
                    ...
                    foreach($row22 as $result22){?>
                        <td><a href="total-beneficiary.php?roll=capacity&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=<?php echo $result22['id'];?>&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=<?php echo $result22['Name'];?>" target="_blank">
                        ...
                        <!--<td></td>-->
                        <td><a href="total-beneficiary.php?roll=surveyrejected&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=0&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=Survey Rejected" target="_blank"><?php echo getDetails('surveyrejected',$result['District'],'0');?></a></td>
                        ...
                        <td style="background-color:#fee2d6;"><a href="total-beneficiary.php?roll=installation&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=No&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=Installation Pending" target="_blank"><?php echo getDetails('installation',$result['District'],'No');?></a></td>
                         ...
                         <td><a href="total-beneficiary.php?roll=meterinstall&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&val=Yes&title=Meter Installed Done" target="_blank"><?php echo getDetails('MeterInstDiscom',$result['District'],'Yes');?></a></td>
                        
                        <td><a href="total-beneficiary.php?roll=meterinstall&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&val=No&title=Meter Installed Pending" target="_blank"><?php echo getDetails('MeterInstDiscom',$result['District'],'No');?></a></td>
                        
                        <td><a href="total-beneficiary.php?roll=dataupload&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&val=Yes&title=Data Upload Done" target="_blank"><?php echo getDetails('dataupload',$result['District'],'Yes');?></a></td>
                        
                        <td style="background-color:#fee2d6;"><a href="total-beneficiary.php?roll=dataupload&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=No&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=Data Upload Pending" target="_blank"><?php echo getDetails('dataupload',$result['District'],'No');?></a></td>
                        ...
                        <td style="background-color:#fee2d6;"><a href="total-beneficiary.php?roll=inspection&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=No&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=Inspection Pending" target="_blank"><?php echo getDetails('inspection',$result['District'],'No');?></a></td>
                        
                        <td style="background-color:#fee2d6;"><a href="total-beneficiary.php?roll=paymentstatus&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=2&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=Complete Payment Received" target="_blank"><?php echo getDetails('paymentstatus',$result['District'],'2');?></a></td>
                        
                        <td style="background-color:#fee2d6;"><a href="total-beneficiary.php?roll=paymentstatus&dist=<?php echo $result['District'];?>&projid=<?php echo $_REQUEST['projid'];?>&val=1&subheadid=<?php echo $_REQUEST['SubHeadProjectId'];?>&title=Partial Payment Received" target="_blank"><?php echo getDetails('paymentstatus',$result['District'],'1');?></a></td>
                    </tr>
                    <?php $i++;} ?>
