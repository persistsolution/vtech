...
<option selected="" value="">Select Customer</option>
 <?php 
 if($_GET['CustId'] == ''){
$sql12 = "SELECT * FROM tbl_rooftop_installations WHERE WarrantyReg='Yes'";
 }
 else{
  $sql12 = "SELECT * FROM tbl_rooftop_installations WHERE WarrantyReg='Yes' AND CustId='".$_GET['CustId']."'";
}
  $row12 = getList($sql12);
