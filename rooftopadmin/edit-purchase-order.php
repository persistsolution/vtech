...
$query22 = "SELECT count(*) as totrec FROM tbl_rooftop_purchase_order_products WHERE SellId = '$id'";
...
if($_GET["action"]=="deleteprd")
{
  $id = $_GET["id"];
  $bid = $_GET["oid"];
  $sql11 = "DELETE FROM tbl_rooftop_purchase_order_products WHERE id = '$id'";
  $conn->query($sql11);
  $sql11 = "DELETE FROM tbl_rooftop_stocks WHERE PostId = '$id'";
  $conn->query($sql11);
  ?>
...
if($_REQUEST["action"]=="deletelink")
{
  $id = $_REQUEST["id"];
  $pid = $_REQUEST["pid"];
  $sql11 = "DELETE FROM tbl_rooftop_po_references WHERE id = '$id'";
  $conn->query($sql11);
?>
    <script type="text/javascript">
      alert("Deleted Successfully!");
...
$sql22 = "DELETE FROM tbl_rooftop_general_ledger WHERE SellId='$id' AND SellType='Purchase'";
$conn->query($sql22);


$sql2 = "SELECT MAX(SrNo) as maxid FROM tbl_rooftop_general_ledger WHERE Type='PW'";
    $row2 = getRecord($sql2);
    if($row2['maxid'] == ''){
        $SrNo = 1;
        $Code = "PW".$SrNo;
    ...
    $sql3 = "INSERT INTO tbl_rooftop_general_ledger SET CompId='$CompId',SrNo='0',Code='',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',Amount='$Total',CrDr='cr',Roll=3,Type='PO',CreatedDate='$CreatedDate',SellId='$SellId',PaymentDate='$InvoiceDate',SellType='Purchase',BranchId='$BranchId'";
    $conn->query($sql3);

    $sql4 = "INSERT INTO tbl_rooftop_general_ledger SET CompId='$CompId',SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',Amount='$Total',CrDr='dr',Roll=3,Type='PW',CreatedDate='$CreatedDate',SellId='$SellId',PaymentDate='$InvoiceDate',SellType='Purchase',BranchId='$BranchId'";
    $conn->query($sql4);

    if($CgstPer > 0){
        $sql4 = "INSERT INTO tbl_rooftop_general_ledger SET CompId='$CompId',SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',Amount='$CgstAmt',GstPer='$CgstPer',CrDr='dr',Roll=3,Type='CGST',CreatedDate='$CreatedDate',SellId='$SellId',PaymentDate='$InvoiceDate',SellType='Purchase',BranchId='$BranchId'";
    $conn->query($sql4);
    }
    if($SgstPer > 0){
        $sql4 = "INSERT INTO tbl_rooftop_general_ledger SET CompId='$CompId',SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',Amount='$SgstAmt',GstPer='$SgstPer',CrDr='dr',Roll=3,Type='SGST',CreatedDate='$CreatedDate',SellId='$SellId',PaymentDate='$InvoiceDate',SellType='Purchase',BranchId='$BranchId'";
    $conn->query($sql4);
    }
    if($IgstPer > 0){
        $sql4 = "INSERT INTO tbl_rooftop_general_ledger SET CompId='$CompId',SrNo='$SrNo',Code='$Code',UserId='$CustId',AccountName='$CustName',InvoiceNo='$InvoiceNo',Amount='$IgstAmt',GstPer='$IgstPer',CrDr='dr',Roll=3,Type='IGST',CreatedDate='$CreatedDate',SellId='$SellId',PaymentDate='$InvoiceDate',SellType='Purchase',BranchId='$BranchId'";
    $conn->query($sql4);
    }
