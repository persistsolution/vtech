 <div class="row">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users WHERE ProjectId='103' AND ProjectSubHeadId='".$_GET['id']."' AND Roll=5 AND ProjectType=2";
                             ...
                             <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql47 = "SELECT * FROM tbl_users WHERE ProjectId='103' AND ProjectSubHeadId='".$_GET['id']."' AND Roll=5 AND FieldSurveyDetails=1 AND ProjectType=2";
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users WHERE ProjectId='103' AND ProjectSubHeadId='".$_GET['id']."' AND Roll=5 AND FieldSurveyDetails=0 AND ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                          ...
                          <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users WHERE ProjectId='103' AND ProjectSubHeadId='".$_GET['id']."' AND Roll=5 AND FieldSurveyDetails=2 AND ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                    ...
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.Inst_Dispatcher_Otp_Verify=1 AND tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                    ...
                    LEFT JOIN tbl_users tu ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.InstallStatus='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_installations ti 
                    LEFT JOIN tbl_users tu ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.PoInspection='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.SentToHo='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.SentToHo='No' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.FileInHand='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.FileInHand='No' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.CircleOfficeStatus='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.RmsIntegrationStatus='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.InsuranceApproval='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.InsuranceApproval='No' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                              ...
                              <a href="total-installations.php?projid=103&page=15&PaymentDone=Yes&title=Total Site Payment Received&subheadid=<?php echo $_GET['id'];?>">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.PaymentDone='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
                              ...
                              <a href="total-installations.php?projid=103&page=16&PaymentDone=No&title=Total Site Payment Pending&subheadid=<?php echo $_GET['id'];?>">
                               <div class="card mb-4 bg-pattern-3-dark">
                                    <div class="card-body" style="padding-top: 15px; padding-bottom: 15px; padding-right: 5px; padding-left: 10px;">
                                        ...
                                        <div class="text-large"><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_rooftop_installations ti ON ti.CustId=tu.id WHERE tu.ProjectId='103' AND tu.ProjectSubHeadId='".$_GET['id']."' AND tu.Roll=5 AND ti.PaymentDone='No' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4);
