...
<option selected="" disabled=""  value="">Select Type Of Pump</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=4 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" value="">Select Pump Outlet Size</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=12 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" disabled="" value="">Select Pump Capacity</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=2 ORDER BY id ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" value="">Select Pump Head</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=1 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" value="">Select Module Watt</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=15 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" value="">Select Module Qty</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=16 ORDER BY id ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" value="">Select Structure</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=17 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" disabled="" value="">Select Module Make</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=22 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" disabled="" value="">Select Structure Make</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=23 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<option selected="" disabled="" value="">Select Insurance Agency</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=9 ORDER BY Name ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
