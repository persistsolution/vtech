...
function commonMaster($id){
    global $conn;
    $sql = "SELECT * FROM tbl_rooftop_common_master WHERE id='$id'";
    $res = $conn->query($sql);
    $row = $res->fetch_assoc();
    return $row['Name'];
}
...
<div class="stepper-wrapper">
 ...
 <?php if($rncnt88 > 0){?>
  ...
  <div class="stepper-item completed">
    ...
    <div class="step-name" style="text-align: center;">DISCOM Approval <br><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $row99['DataUploadDate'])));?></div>
  </div>
  <?php } else {?>
  <div class="stepper-item">
    <div class="step-counter">7</div>
    <div class="step-name" style="text-align: center;">DISCOM Approval</div>
  </div>
  <?php } ?>
...
<div class="stepper-wrapper">
  ...
  <?php } ?>
   ...
   <?php if($row99['DataUploadNational'] == 'Yes'){?>
  <div class="stepper-item completed">
    <div class="step-counter">10</div>
    <div class="step-name" style="text-align: center;">Data Updated On National Portal <br><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $row99['DataUploadNationalDate'])));?></div>
  </div>
  <?php } else {?>
  <div class="stepper-item">
    <div class="step-counter">10</div>
    <div class="step-name" style="text-align: center;">Data Updated On National Portal</div>
  </div>
  <?php } ?>
  
   <?php if($row99['SubsidyRedeemed'] == 'Yes'){?>
  <div class="stepper-item completed">
    <div class="step-counter">11</div>
    <div class="step-name" style="text-align: center;">Subsidy Redeemed <br><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $row99['SubsidyRedeemedDate'])));?></div>
  </div>
  <?php } else {?>
  <div class="stepper-item">
    <div class="step-counter">11</div>
    <div class="step-name" style="text-align: center;">Subsidy Redeemed</div>
  </div>
  <?php } ?>

  <?php if($row99['SubsidyAproved'] == 'Yes'){?>
  <div class="stepper-item completed">
    <div class="step-counter">12</div>
    <div class="step-name" style="text-align: center;">Subsidy Approved <br><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $row99['SubsidyAprovedDate'])));?></div>
  </div>
  <?php } else {?>
  <div class="stepper-item">
    <div class="step-counter">12</div>
    <div class="step-name" style="text-align: center;">Subsidy Approved</div>
  </div>
  <?php } ?>
  
<?php if($row99['SubsidyDisbursed'] == 'Yes'){?>
  <div class="stepper-item completed">
    <div class="step-counter">13</div>
    <div class="step-name" style="text-align: center;">Subsidy Disbursed <br><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $row99['SubsidyDisbursedDate'])));?></div>
  </div>
  <?php } else {?>
  <div class="stepper-item">
    <div class="step-counter">13</div>
    <div class="step-name" style="text-align: center;">Subsidy Disbursed</div>
  </div>
  <?php } ?>
...
<option selected="" disabled="" value="">Select Type Of Source</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=3 ORDER BY Name ASC";
        $r = $conn->query($q);
...
<option selected="" disabled="" value="">Select Bore Diameter</option>
  <?php 
        $q = "select * from tbl_rooftop_common_master WHERE Status='1' AND Roll=7 ORDER BY id ASC";
        $r = $conn->query($q);
        while($rw = $r->fetch_assoc())
    {
?>
...
<?php  
$sql = "SELECT * FROM tbl_rooftop_common_master WHERE Status=1 AND Roll=18";
$rncnt = getRow($sql);?>
...
<?php  
$sql = "SELECT * FROM tbl_rooftop_common_master WHERE Status=1 AND Roll=19";
$rncnt = getRow($sql);?>
<input type="hidden" name="Rncnt" id="Rncnt" value="<?php echo $rncnt;?>">
<?php 
$row = getList($sql);
...
<?php  
$sql = "SELECT * FROM tbl_rooftop_common_master WHERE Status=1 AND Roll=20";
$rncnt = getRow($sql);?>
<input type="hidden" name="Rncnt" id="Rncnt" value="<?php echo $rncnt;?>">
<?php 
$row = getList($sql);
...
<?php  
$sql = "SELECT * FROM tbl_rooftop_common_master WHERE Status=1 AND Roll=21";
$rncnt = getRow($sql);?>
<input type="hidden" name="Rncnt" id="Rncnt" value="<?php echo $rncnt;?>">
<?php 
$row = getList($sql);
