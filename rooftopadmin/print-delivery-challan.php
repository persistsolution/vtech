...
$id = $_GET['id'];
$id = $_GET['id'];
$sql7 = "SELECT tp.*,tu.GstNo,tu.EmailId,tu.Phone2,tu2.Fname As CompName,tu2.Address As CompAddress,tu2.EmailId AS CompEmailId,tu2.Phone As CompPhone,tu2.Phone2 AS CompPhone2,tu3.Fname As AgencyName,tu3.Phone As AgencyPhone,tu3.EmailId As AgencyEmailId,tu2.Photo AS CompLogo,tu3.Address As AgencyAddress FROM tbl_rooftop_sell tp 
...
$sql2 = "SELECT SUM(Qty) AS TotQty FROM `tbl_rooftop_sell_products` WHERE SellId='$id'";
$row2 = getRecord($sql2);
$TotQty = $row2['TotQty'];
...
<?php 
$i=1;
  $sql12 = "SELECT * FROM tbl_rooftop_sell_products WHERE SellId='$id' AND ProductName!=''";
  $row12 = getList($sql12);
