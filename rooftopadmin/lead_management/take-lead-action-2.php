...
$id = $_GET['id'];
$CompId = $_GET['qid'];
$sql7 = "SELECT * FROM tbl_rooftop_lead_details WHERE id='$id'";
$row7 = getRecord($sql7);

$sql77 = "SELECT * FROM tbl_rooftop_leads WHERE id='$CompId'";
...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_rooftop_lead_details SET CompId='$CompId',Message='$Message',ClainStatus='$ClainStatus',CreatedDate='$CreatedDate',CreatedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime',DoneBy='$DoneBy'";
  $conn->query($qx);
 $PostId = mysqli_insert_id($conn);
  $sql = "UPDATE tbl_rooftop_leads SET ClainStatus='$ClainStatus',NextDate='$NextDate',NextTime='$NextTime',DoneBy='$DoneBy' WHERE id='$CompId'";
  $conn->query($sql);
  ...
  window.opener.location.reload(true);</script>";
    ...
    $query2 = "UPDATE tbl_rooftop_lead_details SET CompId='$CompId',Message='$Message',ClainStatus='$ClainStatus',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime',DoneBy='$DoneBy' WHERE id = '$id'";
  $conn->query($query2);
...
$i=2;
$id = $_GET['qid'];
  $sql2 = "SELECT tp.*,tu.Fname,tu.Lname FROM tbl_rooftop_lead_details tp 
