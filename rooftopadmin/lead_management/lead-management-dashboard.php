              ...
              <?php include_once '../top_header.php'; ?>
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <?php 
                                $sql2 = "SELECT * FROM tbl_rooftop_leads";
                                $rncnt2 = getRow($sql2);
                            ?>
                            ...
                            <?php 
                                $sql = "SELECT * FROM tbl_rooftop_common_master WHERE Status=1 AND Roll=10";
                                $row = getList($sql);
                                foreach($row as $result){

                                    $sql2 = "SELECT * FROM tbl_rooftop_leads WHERE ClainReason='".$result['Name']."'";
                                    $rncnt2 = getRow($sql2);
                            ?>
                            <div class="col-sm-6 col-xl-2">
                            ...
                            <?php 
                                $sql = "SELECT * FROM tbl_rooftop_common_master WHERE Status=1 AND Roll=11";
                                $row = getList($sql);
                                foreach($row as $result){

                                    $sql2 = "SELECT * FROM tbl_rooftop_leads WHERE ClainStatus='".$result['Name']."'";
                                    $rncnt2 = getRow($sql2);
                            ?>
                            <div class="col-sm-6 col-xl-2">
                                <a href="view-leads.php?ClainReason=<?php echo $result['Name'];?>">
...
<?php  
    $sql = "SELECT * FROM tbl_rooftop_social_media_marketing WHERE id=1";
    $row = getRecord($sql);
?>
