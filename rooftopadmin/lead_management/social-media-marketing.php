...
$ModifiedDate = date('Y-m-d');
    ...
    $query2 = "UPDATE tbl_rooftop_social_media_marketing SET Videos='$Videos',Blogs='$Blogs',Influencers = '$Influencers',Creative='$Creative',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id' WHERE id = '1'";
  $conn->query($query2);
