...
$id = $_GET['id'];
$CompId = $_GET['qid'];
$sql7 = "SELECT * FROM tbl_rooftop_lead_quotation_details WHERE id='$id'";
$row7 = getRecord($sql7);

$sql77 = "SELECT * FROM tbl_rooftop_lead_quotation WHERE id='$CompId'";
...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_rooftop_lead_quotation_details SET CompId='$CompId',Message='$Message',ClainStatus='$ClainStatus',CreatedDate='$CreatedDate',CreatedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime'";
  $conn->query($qx);

  $sql = "UPDATE tbl_rooftop_lead_quotation SET ClainStatus='$ClainStatus',NextDate='$NextDate',NextTime='$NextTime' WHERE id='$CompId'";
  $conn->query($sql);

  /*echo "<script>alert('Lead Record Saved Successfully!');window.location.href='take-lead-action-2.php?qid=$CompId';</script>";*/
  ...
  window.opener.location.reload(true);</script>";
    ...
    $query2 = "UPDATE tbl_rooftop_lead_quotation_details SET CompId='$CompId',Message='$Message',ClainStatus='$ClainStatus',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime' WHERE id = '$id'";
  $conn->query($query2);

   $sql = "UPDATE tbl_rooftop_lead_quotation SET ClainStatus='$ClainStatus',NextDate='$NextDate',NextTime='$NextTime' WHERE id='$CompId'";
  $conn->query($sql);

  /*echo "<script>alert('Lead Record Updated Successfully!');window.location.href='take-lead-quotation-action-2.php?id=$CompId';</script>";*/
...
$i=2;
$id = $_GET['qid'];
  $sql2 = "SELECT tp.*,tu.Fname,tu.Lname FROM tbl_rooftop_lead_quotation_details tp 
