                        ...
                        <?php if(in_array("56", $Options)) {?>
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_qtn_products";
                                                            echo $rncnt4 = getRow($sql4);

                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Quotation Products</h6>
                                     </div>
                                </div></a>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_branch";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("3", $Options)) {?>
                            <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_issues";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("4", $Options)) {?>
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_scheme";
                                                            echo $rncnt4 = getRow($sql4);
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                        ...
                                                        ?></h2>
                                        <h6 class="mb-0" style="color: black;">Project Head</h6>
...
<?php } if(in_array("6", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=1";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("7", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=2";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("8", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=3";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("9", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=4";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("12", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=7";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("13", $Options)) {?>
                            <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=8";
                                                            echo $rncnt4 = getRow($sql4);
                            ...
                            <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=10";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("16", $Options)) {?>
                            <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=11";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("34", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=9";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("15", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                               ...
                               <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=5";
                                                            echo $rncnt4 = getRow($sql4);
...
<?php } if(in_array("16", $Options)) {?>
                            <!-- <div class="col-sm-6 col-xl-2">
                                ...
                                <div class="card mb-4 bg-pattern-2-dark">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_rooftop_common_master WHERE Roll=6";
                                                            echo $rncnt4 = getRow($sql4);
