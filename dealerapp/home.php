        ...
        <div class="main-container  text-center" style="background-color:#fff;">
           ...
           <div class="row justify-content-equal no-gutters mt-4">
                            ...
                            <div class="col-4 col-md-2 mb-3">
                                ...
                                <p class="text-secondary"><small style="font-size: 12px;font-weight: 700;font-family: Sans-serif;text-transform: uppercase;color:#000;">My <br>Quotation</small></p>
                            </div>
                        
                        <div class="col-4 col-md-2 mb-3">
                                <a href="create-quotation.php">
                                    <div class="avatar avatar-70 mb-1 rounded">
                                        <div class="background">
                                ...
                                <p class="text-secondary"><small style="font-size: 12px;font-weight: 700;font-family: Sans-serif;text-transform: uppercase;color:#000;">Make <br>Quotation</small></p>
                            </div>
                            ...
                            <div class="col-4 col-md-2 mb-3">
                                ...
                                <p class="text-secondary"><small style="font-size: 12px;font-weight: 700;font-family: Sans-serif;text-transform: uppercase;color:#000;">My <br>Customers</small></p>
                            </div>
