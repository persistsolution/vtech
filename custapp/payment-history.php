...
<?php 
$sql = "SELECT TotalAmount FROM tbl_users WHERE id='$UserId'";
$row = getRecord($sql);
?>
            ...
            <div class="card">
                ...
                <div class="card-body px-0 pt-0">
                    <span style="text-align: center;font-weight: 500;font-size: 20px;">
                        <div class='alert alert-warning'>Total Solar Amount : &#8377;<?php echo number_format($row['TotalAmount'], 2); ?></div>
                    </span>
                    <ul class="list-group list-group-flush" id="show_prod">
                        <?php
                        $sql2 = "SELECT * FROM tbl_general_ledger WHERE Type='PR' AND UserId='$UserId'";
                                ...
                                <li class="list-group-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col align-self-center pr-0">
                                            ...
                                            <strong>Payment Date : </strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', $row['CreatedDate']))) ?></p>
                                            <h7 class="font-weight-normal" style="color: #212529"><?php echo $row['Narration']; ?><br></h7>
                                        </div>
                                        <div class="col-auto">
                                            <?php echo $Status; ?>
                                        </div>
