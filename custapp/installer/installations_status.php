...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main"  style="background-color:#405189;">
        ...
        <?php 
            ...
            //pending
            $sql2 = "SELECT * FROM tbl_users WHERE InstallerId='$user_id' AND InstOtpVerify=0";
            $rncnt2 = getRow($sql2);
            
            //done
            $sql3 = "SELECT * FROM tbl_users WHERE InstallerId='$user_id' AND InstOtpVerify=1";
            $rncnt3 = getRow($sql3);
             ?>
        ...
        <div class="container mt-3  text-center text-white">
            ...
            <p class="mb-4" style="text-transform: uppercase;">Total Installation</p>
        
        </div>
        <div class="main-container"  style="background-color:#f0f3f7;">
            <div class="container ">
                <a href="installations.php?val=0">
                <div class="card border-0 mb-3"   style="border-radius: 20px;">
                    <div class="card-header">
                        <div class="row align-items-center">
                            
                            <div class="col align-self-center pr-0">
                                <h6 class="mb-0" style="text-align: center;text-transform: uppercase;">Pending Installation</h6>
                            </div>
                 ...
                 <a href="installations.php?val=1">
                <div class="card border-0 "   style="border-radius: 20px;">
                    <div class="card-header" >
                        <div class="row align-items-center">
                            
                            <div class="col align-self-center pr-0">
                                <h6 class="mb-0" style="text-align: center;text-transform: uppercase;">Completed Installation</h6>
                            </div>
