    ...
    <div class="main-menu">
        ...
        <?php } } ?>
            <ul class="nav nav-pills flex-column ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/survey_status.php">
                        <div>
                ...
                <?php } if(in_array("86", $Options)) {?>
                 <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/dispatch_status.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Dispatch
                        </div>
            ...
            <?php } if(in_array("87", $Options)) {?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/installations_status.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Installation
                        </div>
             ...
             <?php } if(in_array("88", $Options)) {?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $SiteUrl;?>/inspection_status.php">
                        <div>
                            <span class="material-icons icon">view_list</span>
                            Inspection
                        </div>
