! function(t, e) {
    var i = function(t) {
        ...
        return i.m = t, i.c = e, i.d = function(t, e, a) {
            ...
            416: function(t, e, i) {
                "use strict";
                var a = $.fn.bootstrapMaterialDatePicker;
                $.fn.bootstrapMaterialDatePicker = function() {
                    for (var t = arguments.length, e = Array(t), i = 0; i < t; i++) e[i] = arguments[i];
                    return this.each(function() {
                        var t = !$.data(this, "plugin_bootstrapMaterialDatePicker");
                        if (a.apply($(this), e), t) {
                            var i = $("body").find("> #" + $.data(this, "plugin_bootstrapMaterialDatePicker").name);
                            i.addClass("animated fadeIn"), i.find(".dtp-btn-now,.dtp-btn-clear,.dtp-btn-cancel").addClass("btn-default btn-sm"), i.find(".dtp-btn-ok").addClass("btn-primary btn-sm")
                        }
                    }), this
                }
            },
            417: function(t, e) {
                ! function(t, e) {
                    var i = "plugin_bootstrapMaterialDatePicker";
                    ...
                    e.locale("en"), t.fn.bootstrapMaterialDatePicker = function(e, s) {
                        return this.each(function() {
                            t.data(this, i) ? ("function" == typeof t.data(this, i)[e] && t.data(this, i)[e](s), "destroy" === e && t.data(this, i)) : t.data(this, i, new a(this, e))
                        }), this
                    }, a.prototype = {
                        init: function() {
                        ...
                        initDates: function() {
                            if (this.$element.val().length > 0) void 0 !== this.params.format && null !== this.params.format ? this.currentDate = e(this.$element.val(), this.params.format).locale(this.params.lang) : this.currentDate = e(this.$element.val()).locale(this.params.lang);
                            else if (void 0 !== this.$element.attr("value") && null !== this.$element.attr("value") && "" !== this.$element.attr("value")) "string" == typeof this.$element.attr("value") && (void 0 !== this.params.format && null !== this.params.format ? this.currentDate = e(this.$element.attr("value"), this.params.format).locale(this.params.lang) : this.currentDate = e(this.$element.attr("value")).locale(this.params.lang));
                            else if (void 0 !== this.params.currentDate && null !== this.params.currentDate) {
                                if ("string" == typeof this.params.currentDate) void 0 !== this.params.format && null !== this.params.format ? this.currentDate = e(this.params.currentDate, this.params.format).locale(this.params.lang) : this.currentDate = e(this.params.currentDate).locale(this.params.lang);
                            ...
                            if (void 0 !== this.params.minDate && null !== this.params.minDate)
                                if ("string" == typeof this.params.minDate) void 0 !== this.params.format && null !== this.params.format ? this.minDate = e(this.params.minDate, this.params.format).locale(this.params.lang) : this.minDate = e(this.params.minDate).locale(this.params.lang);
                            ...
                            if (void 0 !== this.params.maxDate && null !== this.params.maxDate)
                                if ("string" == typeof this.params.maxDate) void 0 !== this.params.format && null !== this.params.format ? this.maxDate = e(this.params.maxDate, this.params.format).locale(this.params.lang) : this.maxDate = e(this.params.maxDate).locale(this.params.lang);
                        ...
                        initTemplate: function() {
                            for (var e = "", i = this.currentDate.year(), a = i - 3; a < i + 4; a++) e += '<div class="year-picker-item" data-year="' + a + '">' + a + "</div>";
                            this.midYear = i;
                            var s = '<div class="dtp-picker-year hidden"> <
                                div > < a href = "javascript:void(0);"
                            class = "btn btn-default dtp-select-year-range before"
                            style = "margin: 0;" > < i class = "material-icons" > keyboard_arrow_up < /i></a > < /div>'+e+'<div><a href="javascript:void(0);" class="btn btn-default dtp-select-year-range after" style="margin: 0;"><i class="material-icons">keyboard_arrow_down</i > < /a></div >
                                <
                                ...
                                div >
                                <
                                div class = "left center p10" > < a href = "javascript:void(0);"
                            class = "dtp-select-month-before" > < i class = "material-icons" > chevron_left < /i></a > < /div> <
                                div class = "dtp-actual-month p80" > MAR < /div> <
                                div class = "right center p10" > < a href = "javascript:void(0);"
                            class = "dtp-select-month-after" > < i class = "material-icons" > chevron_right < /i></a > < /div> <
                                ...
                                <
                                div class = "left center p10" > < a href = "javascript:void(0);"
                            class = "dtp-select-year-before" > < i class = "material-icons" > chevron_left < /i></a > < /div> <
                                div class = "dtp-actual-year p80'+(this.params.year?"
                            ":"
                            disabled ")+'" > 2014 < /div> <
                                div class = "right center p10" > < a href = "javascript:void(0);"
                            class = "dtp-select-year-after" > < i class = "material-icons" > chevron_right < /i></a > < /div> <
                                div class = "clearfix" > < /div> <
                                /div> <
                                /div> <
                                ...
                                <
                                div class = "left p20" > < a class = "dtp-meridien-am"
                            href = "javascript:void(0);" > AM < /a></div >
                                <
                                div class = "dtp-actual-time p60" > < /div> <
                                div class = "right p20" > < a class = "dtp-meridien-pm"
                            href = "javascript:void(0);" > PM < /a></div >
                                <
                                div class = "clearfix" > < /div> <
                                /div> <
                    ...
                    l.textContent = 0 === i && this.params.shortTime ? 12 : i, this.toggleTime(i, !0) ? (d.addEventListener("click", this._onSelectHour.bind(this)), l.addEventListener("click", this._onSelectHour.bind(this))) : (d.className += " disabled", l.className += " disabled", l.setAttribute("fill", "#bdbdbd")), e.appendChild(d), e.appendChild(l)
                }
                if (!this.params.shortTime) {
                    for (var i = 0; i < 12; i++) {
                        ...
                        l.textContent = i + 12, this.toggleTime(i + 12, !0) ? (d.addEventListener("click", this._onSelectHour.bind(this)), l.addEventListener("click", this._onSelectHour.bind(this))) : (d.className += " disabled", l.className += " disabled", l.setAttribute("fill", "#bdbdbd")), e.appendChild(d), e.appendChild(l)
                    }
            ...
            initMinutes: function() {
                ...
                for (var t = this.createSVGClock(!1), e = 0; e < 60; e++) {
                    ...
                    this.toggleTime(e, !1) ? d.addEventListener("click", this._onSelectMinute.bind(this)) : d.className += " disabled", t.appendChild(d)
                }
                for (var e = 0; e < 60; e++)
                    if (e % 5 == 0) {
                        ...
                        l.textContent = e, this.toggleTime(e, !1) ? l.addEventListener("click", this._onSelectMinute.bind(this)) : (l.className += " disabled", l.setAttribute("fill", "#bdbdbd")), t.appendChild(l)
                    } this._centerBox()
            },
                ...
                if (null !== t) {
                    ...
                    for (var r = a.date(); r <= s.date(); r++) {
                        if (r === a.date()) {
                            ...
                            if (d > 0)
                                for (var l = 0; l < d; l++) i.days.push(0)
                        }
            ...
            enableDays: function() {
                ...
                e && t(".dtp-picker-days tbody tr td").each(function() {
                    t.inArray(t(this).index(), e) >= 0 || t(this).find("a").css({
                        background: "#e3e3e3",
                        cursor: "no-drop",
                        opacity: "0.5"
                    }).off("click")
