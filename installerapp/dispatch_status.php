...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main"  style="background-color:#405189;">
        ...
        <?php 
            ...
            $rncnt = getRow($sql);
            $sql11 = "SELECT tdo.*,tu.Fname,tu.Phone,tu.Address FROM tbl_rooftop_sell tdo 
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.DispatcherId='$user_id'";
            ...
            $rncnt2 = getRow($sql2);
            $sql21 = "SELECT tdo.*,tu.Fname,tu.Phone,tu.Address FROM tbl_rooftop_sell tdo 
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.DispatcherId='$user_id' AND tdo.Inst_Dispatcher_Otp_Verify=0";
            $rncnt21 = getRow($sql21);
            ...
            $rncnt3 = getRow($sql3);
            $sql31 = "SELECT tdo.*,tu.Fname,tu.Phone,tu.Address FROM tbl_rooftop_sell tdo 
                    LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.DispatcherId='$user_id' AND tdo.Inst_Dispatcher_Otp_Verify=1";
            $rncnt31 = getRow($sql31);
             ?>
        ...
        <div class="container mt-3  text-center text-white">
            <h2 style="font-size: 50px;"><?php echo $rncnt+$rncnt11;?></h2>
        ...
        <div class="main-container"  style="background-color:#f0f3f7;">
            <div class="container ">
                ...
                <div class="card border-0 mb-3"   style="border-radius: 20px;">
                    ...
                    <div class="card-body">
                        <h1 class=" text-center mb-0 display-4" style="color: red;font-size:3rem;"><?php echo $rncnt2+$rncnt21;?></h1>
                    </div>
                ...
                <div class="card border-0 "   style="border-radius: 20px;">
                    ...
                    <div class="card-body">
                        <h1 class=" text-center mb-0 display-4"  style="color: green;font-size:3rem;"><?php echo $rncnt3+$rncnt31;?></h1>
                    </div>
