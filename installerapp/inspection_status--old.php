...
<body class="body-scroll d-flex flex-column h-100 menu-overlay">
    ...
    <main class="flex-shrink-0 main"  style="background-color:#405189;">
        ...
        <?php 
            //total
           echo $sql = "SELECT * FROM tbl_users WHERE InspectionId='$user_id' AND InspectionStatus=1";
            $rncnt = getRow($sql);
            
            //pending
            $sql2 = "SELECT * FROM tbl_users WHERE InspectionId='$user_id' AND InspectionOtpVerify=0 AND InspectionStatus=1";
            $rncnt2 = getRow($sql2);
            
            //done
            $sql3 = "SELECT * FROM tbl_users WHERE InspectionId='$user_id' AND InspectionOtpVerify=1 AND InspectionStatus=1";
            $rncnt3 = getRow($sql3);
             ?>
        ...
        <div class="container mt-3  text-center text-white">
            ...
            <p class="mb-4" style="text-transform: uppercase;">Total Inspection</p>
        
        </div>
        <div class="main-container"  style="background-color:#f0f3f7;">
            <div class="container ">
                <a href="inspections.php?val=0">
                <div class="card border-0 mb-3"   style="border-radius: 20px;">
                    <div class="card-header">
                        <div class="row align-items-center">
                            
                            <div class="col align-self-center pr-0">
                                <h6 class="mb-0" style="text-align: center;text-transform: uppercase;">Pending Inspection</h6>
                            </div>
                 ...
                 <a href="inspections.php?val=1">
                <div class="card border-0 "   style="border-radius: 20px;">
                    <div class="card-header" >
                        <div class="row align-items-center">
                            
                            <div class="col align-self-center pr-0">
                                <h6 class="mb-0" style="text-align: center;text-transform: uppercase;">Completed Inspection</h6>
                            </div>
