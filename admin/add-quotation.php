...
<option selected="" value="">Select Customer</option>
 <?php 
 if($Roll==1 || $Roll==7){
  $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll=5 AND CoordinatorStatus=1 AND ProjectType=2";
   }
   else{
     $sql12 = "SELECT * FROM tbl_users WHERE Status='1' AND Roll=5 AND CoordinatorStatus=1 AND ProjectType=2 AND CoordinatorId='$user_id'";
 }
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
