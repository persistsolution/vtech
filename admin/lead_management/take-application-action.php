...
<body>
            ...
            <div class="layout-container">
                ...
                <div class="layout-content">
                    ...
                    <div class="container flex-grow-1 container-p-y">
                        ...
                        $id = $_GET['id'];
                        $CompId = $_GET['qid'];
                        $sql7 = "SELECT * FROM tbl_application_lead_details WHERE id='$id'";
                        $row7 = getRecord($sql7);

                        $sql77 = "SELECT * FROM tbl_mp_pump_applications WHERE id='$CompId'";
                        $row77 = getRecord($sql77);
                        $CustName = $row77['applicant_name'];
                        $CellNo = $row77['mobile'];
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($_GET['id'] == '') {
                                $qx = "INSERT INTO tbl_application_lead_details SET CompId='$CompId',Message='$Message',ClainStatus='$ClainStatus',CreatedDate='$CreatedDate',CreatedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime',DoneBy='$DoneBy'";
                                $conn->query($qx);
                                $PostId = mysqli_insert_id($conn);
                                $sql = "UPDATE tbl_mp_pump_applications SET ClainStatus='$ClainStatus',NextDate='$NextDate',NextTime='$NextTime',DoneBy='$DoneBy' WHERE id='$CompId'";
                                $conn->query($sql);
  ...
  window.opener.location.reload(true);</script>";
                                ...
                                $query2 = "UPDATE tbl_application_lead_details SET CompId='$CompId',Message='$Message',ClainStatus='$ClainStatus',ModifiedDate='$ModifiedDate',ModifiedBy='$user_id',NextDate='$NextDate',NextTime='$NextTime',DoneBy='$DoneBy' WHERE id = '$id'";
                                $conn->query($query2);
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" name="CustName" id="CustName" class="form-control"
                                                        placeholder="" value="<?php echo $row77["applicant_name"]; ?>"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" name="CellNo" id="CellNo" class="form-control"
                                                        placeholder="" value="<?php echo $row77["mobile"]; ?>"
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="district" class="form-control" required value="<?php echo $row77['district']; ?>" disabled>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label class="form-label">Tehsil (तहसील) <span class="text-danger">*</span></label>
                                                    <input type="text" name="tehsil" class="form-control" required value="<?php echo $row77['tehsil']; ?>" disabled>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label class="form-label">Village (गांव) <span class="text-danger">*</span></label>
                                                    <input type="text" name="village" class="form-control" required value="<?php echo $row77['village']; ?>" disabled>
                                                </div>
                                        ...
                                        <div class="container-fluid flex-grow-1 container-p-y">
                                            ...
                                            <div class="row help-desk">
                                                <div class="col-xl-12 col-lg-12">
                                                    ...
                                                    $i = 2;
                                                    $id = $_GET['qid'];
                                                    $sql2 = "SELECT tp.*,tu.Fname,tu.Lname FROM tbl_application_lead_details tp 
