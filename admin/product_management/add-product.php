...
if($_GET['id']==''){
     $qx = "INSERT INTO tbl_products SET CGST='$CGST',SGST='$SGST',IGST='$IGST',Photo2='$Photo2',ProductCode='$ProductCode',BrandId='$BrandId',CatId='$CatId',ProductName = '$ProductName',Status='$Status',ModelNo='$ModelNo',Photo='$Photo',Price = '$Price',Details='$Details',CreatedDate='$CreatedDate',CreatedBy='$user_id',Code='$Code',Unit='$Unit',Roll='$Roll',BarcodeNo='$BarcodeNo',ProdSpec='$ProdSpec'";
  $conn->query($qx);
