               ...
               <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-primary text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2><?php  
                        $sql4 = "SELECT tu.* FROM tbl_lead_quotation ts 
                          ...
                          <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-warning text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT tq.* FROM tbl_quotation tq INNER JOIN tbl_users tu ON tq.CustId=tu.id WHERE tu.StateId='".$_GET['id']."' AND tu.Roll=5 AND tu.FieldSurveyDetails=2";
                                                            echo $rncnt4 = getRow($sql4);
...
<div class="col-sm-6 col-xl-3">
 ...
 <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT SUM(ti.PaidAmount) AS PaidAmount FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.stateid='".$_GET['id']."' AND tu.Roll=5 AND ti.PaymentDone='Yes' AND tu.ProjectType=2";
                                         $row4 = getRecord($sql4);
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-secondary text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT SUM(ti.BalanceAmount) AS BalanceAmount FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.stateid='".$_GET['id']."' AND tu.Roll=5 AND ti.PaymentDone='Yes' AND tu.ProjectType=2";
                                                         $row4 = getRecord($sql4);
                            ...
                            <div class="col-sm-6 col-xl-3">
                               ...
                               <div class="card bg-info text-white ui-hover-icon mb-4 bg-pattern-3">
                                        <div class="card-body text-center">
                                          <h2><?php  
                                                            $sql4 = "SELECT * FROM tbl_users tu LEFT JOIN tbl_installations ti ON ti.CustId=tu.id WHERE tu.StateId='".$_GET['id']."' AND tu.Roll=5 AND ti.MeterDiscom='Yes' AND tu.ProjectType=2";
                                                            echo $rncnt4 = getRow($sql4); 
