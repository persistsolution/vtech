...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
 ...
 $srno = 1;
  $sql = "SELECT * FROM tbl_products WHERE Status='1' AND Roll!=1 AND ProdSpec=2 ORDER BY id DESC";
   $rx = $conn->query($sql);
...
<table id="example2" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
 ...
 $sql = "SELECT tp.id,tp.ProductName,tp.Unit,tps.Qty,tps.Structure FROM tbl_struct_product_specification tps 
         INNER JOIN tbl_products tp ON tps.ProdId=tp.id WHERE tp.Roll!=1 AND tps.Qty>0 AND tp.ProdSpec=2";
      if($AcDc!=''){
