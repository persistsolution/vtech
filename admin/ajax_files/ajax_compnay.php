...
echo "<script>alert('Record Created Successfully!');window.location.href='../user_management/view-company.php';</script>";
}
else{
...
echo "<script>alert('Record Updated Successfully!');window.location.href='../user_management/view-company.php';</script>";
}
