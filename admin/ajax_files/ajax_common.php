...
$qx = "INSERT INTO tbl_common_master SET RangeFrom = '$RangeFrom',RangeTo='$RangeTo',PumpHeadId='$PumpHeadId',Level='$Level',Name = '$Name',Status='$Status',Roll='$Roll',ExpTitle='$ExpTitle'";
	$conn->query($qx);
	echo 1;
}
/*}*/
...
if($row_cnt > 0){
  ...
  $query2 = "UPDATE tbl_common_master SET RangeFrom = '$RangeFrom',RangeTo='$RangeTo',PumpHeadId='$PumpHeadId',Level='$Level',Name = '$Name', Status='$Status',Roll='$Roll',ExpTitle='$ExpTitle' WHERE id = '$id'";
 	$conn->query($query2);
 /*}*/
  echo 1;
}
