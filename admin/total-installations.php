...
<script src="assets/js/pages/forms_selects.js"></script>
    <script>
        ...
        $(document).ready(function(){
         $.fn.myFunction = function(ProjectId,InstallStatus,PoInspection,DgmApproval,InsuranceApproval,PaymentDone,CircleOfficeStatus,RmsIntegrationStatus,IcrSignDoOffice,BillForward,RoToRoAccts,RoAcctsToZo,ZoToHo,HoToHoAccts,ForwardToPayment,DispatchStatus,District,SentToHo,FileInHand,SubHeadId){ 
            var PageLength = 5000;
         $('#empTable').DataTable({
                'processing': true,
                'serverSide': true,
    ...
    $.fn.myFunction(ProjectId,InstallStatus,PoInspection,DgmApproval,InsuranceApproval,PaymentDone,CircleOfficeStatus,RmsIntegrationStatus,IcrSignDoOffice,BillForward,RoToRoAccts,RoAcctsToZo,ZoToHo,HoToHoAccts,ForwardToPayment,DispatchStatus,District,SentToHo,FileInHand,SubHeadId);
