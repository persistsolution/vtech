     ...
     <tbody>
        <?php 
           $i=1;                              
            ...
            $sql33 = "SELECT * FROM tbl_distibute_item_details WHERE ProdType=1 AND SerialNo='".$result['SerialNo']."' AND VehicalDate='".$result['VehicalDate']."' AND VehicalNo='".$result['VehicalNo']."'";
