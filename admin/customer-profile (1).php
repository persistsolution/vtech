                       ...
                       <!-- <h4 class="font-weight-bold py-3 mb-0">Users view</h4>
                        ...
                        <div class="media align-items-center py-3 mb-3">
                            ...
                            <div class="media-body ml-4">
                                ...
                                <a href="user_management/add-customer.php?id=<?php echo $row7['id']; ?>" class="btn btn-primary btn-sm">Edit</a>&nbsp;
...
<div class="stepper-wrapper">
  <div class="stepper-item completed">
    ...
    <div class="step-name">Co-ordinator Survey </div>
  </div>
  <div class="stepper-item completed">
    <div class="step-counter">2</div>
    <div class="step-name">Field Survey</div>
  </div>
  <div class="stepper-item active">
    <div class="step-counter">3</div>
    <div class="step-name">Delivery Challan</div>
  </div>
