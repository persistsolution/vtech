...
$sql = "SELECT tu.* FROM tbl_sell tdo 
    ...
    $sql3 = "SELECT GROUP_CONCAT(tdo.CustId) AS CustId FROM tbl_sell tdo LEFT JOIN tbl_users tu ON tdo.CustId=tu.id WHERE tdo.Inst_Dispatcher_Otp_Verify=1 AND tu.StateId='$StateId' AND tu.Roll=5 AND tu.ProjectType=2";
