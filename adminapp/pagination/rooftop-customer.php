...
include '../inc-match-survey.php';
	...
	$SurveyDetails = '<a href="#" class="btn btn-primary btn-finish">Survey Not Done</a>';
	}
    if ($row['SurveyDetails'] == 1) {
	$SurveyDetails = '<a href="#" class="btn btn-success btn-finish">Survey Done</a>';
    }

    if ($row['FieldSurveyDetails'] == 0) {
    	$FieldSurveyDetails = '<a href="#" class="btn btn-primary btn-finish">Survey Not Done</a>';
    }
    if ($row['FieldSurveyDetails'] == 1) {
    	$FieldSurveyDetails = '<a href="#" class="btn btn-success btn-finish">Survey Done</a>';
    }
    ...
    $Action = "<a href='add-rooftop-customer.php?id=".$row['id']."'><i class='lnr lnr-pencil mr-2'></i></a>&nbsp;&nbsp;
